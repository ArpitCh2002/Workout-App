...
object Constants {
    fun defaultExerciseList() : ArrayList<ExerciseModel> {
        ...
        val abdominalCrunch = ExerciseModel(4, "Seated Crunch", R.drawable.ic_seated_crunch,
        false, false)
        exerciseList.add(abdominalCrunch)

        val stepUpOnChair = ExerciseModel(5, "Step Up on Chair", R.drawable.ic_step_onto_chair, false, false)
        exerciseList.add(stepUpOnChair)

        val squat = ExerciseModel(6, "Squat", R.drawable.ic_squat, false, false)
        exerciseList.add(squat)

        val tricepDipOnChair = ExerciseModel(7, "Tricep Dip On Chair", R.drawable.ic_tricep_dip_on_chair, false, false)
        ...
        val pushupAndRotation = ExerciseModel(11, "Knee PushUp", R.drawable.ic_knee_push_up, false, false)
